...
//
//node script.js --key acd1964c4db54b139b779090eb741c11 --region southeastasia --input speech.wav --output caption.output.txt --srt --recognizing --threshold 5 --profanity mask --phrases "Contoso;Jessie;Rehaan"
...
function UserConfigFromArgs(args, usage)
{
    ...
    var key = "acd1964c4db54b139b779090eb741c11";
    if(null === key)
    {
