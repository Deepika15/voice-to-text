...
// // Use the Conversation Transcription API for speaker diarization
// const speechToText = async (filePath, token) => {
//   try {
//     const audioFile = fs.readFileSync(filePath);

//     const response = await axios.post(
//       `https://${serviceRegion}.stt.speech.microsoft.com/speech/recognition/conversation/cognitiveservices/v1?language=en-US&format=detailed&profanity=masked&diarizationEnabled=true`,
//       audioFile,
//       {
//         headers: {
//           'Authorization': `Bearer ${token}`,
...
// // Use Azure Text Analytics API for sentiment analysis
// const analyzeText = async (text) => {
//   console.log("text to anaylyse ", text);
//   try {
//     const response = await axios.post(
//       `https://${serviceRegion}.api.cognitive.microsoft.com/text/analytics/v3.1/sentiment`,
//       {
//         documents: [
//           {
//             language: 'en',
...
//     const transcript = speechResult.NBest[0].Display; // Assuming transcript is in the Display field
//     const analysisResult = await analyzeText(transcript);

//     res.json({ transcript, analysis: analysisResult });
//     console.log("transcript>>>>>>>>>>>>",transcript);
//     // res.json({ transcript, analysis: transcript });
